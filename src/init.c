		     ...
		     const struct mei_hw_ops *hw_ops)
{
	...
	//bitmap_xor(dev->host_clients_map, dev->host_clients_map, dev->host_clients_map, MEI_CLIENTS_MAX);
	//bitmap_or(dev->host_clients_map, dev->host_clients_map, 1, MEI_CLIENTS_MAX);
	*dev->host_clients_map |= 0x1;	
